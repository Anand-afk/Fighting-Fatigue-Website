...
<header>
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    <div class="carousel-caption" id="slide3" style="width: 70%;margin-left: 0px;padding-left: 15%;height: 35%;">
                        <h1 class="text-nowrap" style="font-size: 4vw;width: 130%;margin-left: -30%;font-weight: bold;margin-bottom: 4px;margin-top: -15%;height: auto;color: rgb(255,255,255);background-color: rgba(0,0,0,0.44);">&nbsp; &nbsp;Stay safe by avoiding drowsy driving. <br>Read through our tips to be more vigilant.&nbsp;</h1><a href="tips.html"><button class="btn btn-primary" type="button" style="font-size: 2vw;margin-top: 2%;background-color: rgb(3,19,44);margin-right: 25%;">Find out more!</button></a></div>
                    <img
                        class="img-fluid w-100 d-block" src="Images/mikael-kristenson-MYXf7tGEntk-unsplash.jpg" alt="Slide Image" style="max-height: 600px;"></div>
                <div class="carousel-item">
                    <div class="carousel-caption" id="slide2" style="width: 70%;margin-left: 0px;padding-left: 15%;margin-bottom: 0px;padding-top: 100%;">
                        <h1 class="text-nowrap" style="font-size: 4vw;width: 130%;margin-left: -33%;font-weight: bold;margin-top: -70%;">Watch out for the accident-prone areas<br>&nbsp;by turning on our Alerts today!</h1><a href="login.html"><button class="btn btn-primary" type="button" style="font-size: 2vw;margin-top: 0%;background-color: rgb(27,38,50);margin-right: 25%;">Find out more!</button></a></div>
                    <img
                        class="img-fluid w-100 d-block" src="Images/muukii-rtX4wxMEI2M-unsplash.jpg" alt="Slide Image" style="max-height: 600px;"></div>
                <div class="carousel-item">
                    <div class="carousel-caption" style="width: 70%;margin-left: 0px;margin-bottom: 15%;padding-bottom: 0px;padding-left: 15%;height: 50%;">
                        <h1 class="slideText" style="font-size: 4vw;color: rgb(0,0,0);margin-bottom: 10%;margin-top: -10%;padding-bottom: 0px;font-weight: bold;margin-right: 5%;">Stay Alert, Stay Social! <br>Try our Conversation Starter, and have a different conversation every time!<br><br><a href="prompt.html"><button class="btn btn-primary" type="button" style="font-size: 2vw;">Find out more!</button></a></h1>
    ...
    <section style="background-color: #f8f8f8;padding-top: 20px;">
        <div>
            <h1 class="text-center" style="font-size: 6vw;color: rgb(37,85,90);font-weight: normal;font-style: italic;"><strong><em>Explore FatigueBan!</em></strong></h1>
        </div>
        <div class="card-group" style="padding: 20px;">
            <div class="card text-center border rounded shadow-lg" style="padding: 20px;margin-right: 5px;margin-left: 5px;"><img class="card-img-top w-100 d-block" src="Images/markus-winkler-w8vPcVdSlF8-unsplash.jpg">
                <div class="card-body">
            ...
            <div class="card text-center border rounded shadow-lg" style="padding: 20px;margin-right: 5px;margin-left: 5px;"><img class="card-img-top w-100 d-block" src="Images/markus-spiske-VO5w2Ida70s-unsplash.jpg">
                <div class="card-body">
            ...
            <div class="card text-center border rounded shadow-lg" style="padding: 20px;margin-left: 5px;margin-right: 5px;"><img class="card-img-top w-100 d-block" src="Images/volodymyr-hryshchenko-V5vqWC9gyEU-unsplash.jpg">
                <div class="card-body">
