...
<body style="background-color: rgb(0,0,0);">
        ...
        <div class="carousel slide" data-ride="carousel" data-interval="8000" id="carousel-1">
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    ...
                    </div><img class="img-fluid w-100 d-block" src="img/caleb-george-URmkfvtK3Qw-unsplash.jpg" alt="Slide Image" style="max-height: 600px;"></div>
                <div class="carousel-item">
                    <div class="carousel-caption" id="slide3" style="width: 70%;margin-left: 0px;padding-left: 15%;height: 35%;">
                        <h1 class="text-nowrap" style="font-size: 4vw;width: 130%;margin-left: -30%;font-weight: bold;margin-bottom: 4px;margin-top: -15%;height: auto;color: rgb(255,255,255);background-color: rgba(0,0,0,0.44);">&nbsp; &nbsp;Stay safe by avoiding drowsy driving. <br>Read through our tips to be more vigilant.&nbsp;</h1><a href="tips.blade.php"><button class="btn btn-primary" type="button" style="font-size: 2vw;margin-top: 2%;background-color: rgb(3,19,44);margin-right: 25%;">Find out more!</button></a></div>
                    <img
                        class="img-fluid w-100 d-block" src="img/mikael-kristenson-MYXf7tGEntk-unsplash.jpg" alt="Slide Image" style="max-height: 600px;"></div>
                <div class="carousel-item">
                    <div class="carousel-caption" id="slide2" style="width: 70%;margin-left: 0px;padding-left: 15%;margin-bottom: 0px;padding-top: 100%;">
                        <h1 class="text-nowrap" style="font-size: 4vw;width: 130%;margin-left: -33%;font-weight: bold;margin-top: -70%;">Watch out for the accident-prone areas<br>&nbsp;by turning on our Alerts today!</h1><a href="login.blade.php"><button class="btn btn-primary" type="button" style="font-size: 2vw;margin-top: 0%;background-color: rgb(27,38,50);margin-right: 25%;">Find out more!</button></a></div>
                    <img
                        class="img-fluid w-100 d-block" src="img/muukii-rtX4wxMEI2M-unsplash.jpg" alt="Slide Image" style="max-height: 600px;"></div>
                <div class="carousel-item">
                    <div class="carousel-caption" style="width: 70%;margin-left: 0px;margin-bottom: 15%;padding-bottom: 0px;padding-left: 15%;height: 50%;">
                        <h1 class="slideText" style="font-size: 4vw;color: rgb(0,0,0);margin-bottom: 10%;margin-top: -10%;padding-bottom: 0px;font-weight: bold;margin-right: 5%;">Stay Alert, Stay Social! <br>Try our Conversation Starter, and have a different conversation every time!<br><br><a href="prompt.blade.php"><button class="btn btn-primary" type="button" style="font-size: 2vw;">Find out more!</button></a></h1>
                    </div><img class="img-fluid w-100 d-block" src="img/victor-xok-qd-zd2MoeE8-unsplash.jpg" alt="Slide Image" style="max-height: 600px;"></div>
            </div>
    ...
    <section style="background-color: #f8f8f8;padding-top: 20px;">
        ...
        <div class="card-group" style="padding: 20px;">
            <div class="card text-center border rounded shadow-lg" style="padding: 20px;margin-right: 5px;margin-left: 5px;"><img class="card-img-top w-100 d-block" src="img/markus-winkler-w8vPcVdSlF8-unsplash.jpg">
                <div class="card-body">
                    <h4 class="card-title"><strong>TIPS &amp; TRICKS</strong></h4>
                    <p class="d-sm-flex card-text">Fatigue driving is one of the top 5 reasons of accidents in Victoria! Read our tips and tricks to stay alert and active on roads by avoiding driving while fatigued and drowsy<br></p><a class="card-link" href="tips.blade.php><button class="btn btn-primary" type="button">Learn More</button></a></div>
            </div>
            <div class="card text-center border rounded shadow-lg" style="padding: 20px;margin-right: 5px;margin-left: 5px;"><img class="card-img-top w-100 d-block" src="img/markus-spiske-VO5w2Ida70s-unsplash.jpg">
                <div class="card-body">
                    ...
                    <p class="card-text">Do you think you're alert while driving?<br>&nbsp;Be mindful that while driving you are supposed to be alert ! Driving while tired is risky. Drive safe especially in the accident-prone areas by turning on our Alerts now!</p><a class="card-link"
                        href="login.blade.php"><button class="btn btn-primary" type="button">Learn More</button></a></div>
            </div>
            <div class="card text-center border rounded shadow-lg" style="padding: 20px;margin-left: 5px;margin-right: 5px;"><img class="card-img-top w-100 d-block" src="img/volodymyr-hryshchenko-V5vqWC9gyEU-unsplash.jpg">
                <div class="card-body">
                    ...
                    <p class="card-text">Having an interesting conversation can be one of the most effective ways of staying alert after a long day of work, however sometimes you end up having the same conversation with every passenger, feeling to shy to try bringing up a
                        different topic.</p><a class="card-link" href="prompt.blade.php"><button class="btn btn-primary" type="button">Learn More</button></a></div>
            </div>
        </div>
    </section>
