...
<header>
                ...
                <table class="table">
                    <tbody class="text-center border-primary">
                        <tr class="text-center" style="height: auto;">
                            <td class="border-white" style="padding-top: 40px;width: 230px;padding-bottom: 0px;height: auto;"><img class="img-fluid" data-bs-hover-animate="pulse" src="Images/yawn.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Yawning</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="jello" src="Images/speed.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Irregular speed</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="shake" src="Images/road.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Indefinite lane switching</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="flash" src="Images/sid-view.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Dozing</h1><br><br></td>
                        </tr>
                        <tr class="text-center" style="height: auto;">
                            <td class="border-white" style="width: 230px;height: auto;padding-top: 40px;"><img class="img-fluid" data-bs-hover-animate="swing" src="Images/glasses.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Blurred vision</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="tada" src="Images/slow.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Slower response time</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="bounce" src="Images/icons8-nod-100.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Head nods</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="wobble" src="Images/car-accident.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-top: 20%;">Lack of concentration</h1><br><br></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div>
        <h1 class="text-center" style="font-size: 6vw;color: rgb(4,54,9);font-weight: bold;font-style: italic;border-radius: 20px;background-color: #fff9e3;width: 70%;margin-right: auto;margin-left: auto;padding: 20px;"><strong><em>Beat driver fatigue</em></strong><br></h1>
    </div>
    <div class="article-list" style="background-color: rgb(255,255,255);height: auto;">
        <div class="container" style="padding: 20px;padding-bottom: 0px;">
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="Images/bastien-jaillot-eJwSOguD1rE-unsplash.jpg" style="padding: 20px;"></a>
                    <h3 class="name" style="font-size: 24px;">Get a good night sleep<br></h3>
                    <p class="description" style="padding: 20px;padding-top: 0px;">It is always a good idea to be more careful about having a good night sleep whenever you know that you will have to work overtime as a ridesharing driver or if you plan to be on road for longer hours.<br></p><a class="action" href="tips.html"></a></div>
                <div
                    class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="Images/mike-kenneally-tNALoIZhqVM-unsplash.jpg" style="padding: 20px;"></a>
            ...
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="Images/tim-bish-WbC9XIlQb4k-unsplash.jpg" style="padding: 20px;"></a>
            ...
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="Images/brooke-lark-nTZOILVZuOg-unsplash.jpg" style="padding: 20px;"></a>
            ...
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="Images/lechon-kirb-5tniytQs68E-unsplash.jpg" style="padding: 20px;"></a>
            ...
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="Images/pablo-merchan-montes-wYOPqmtDD0w-unsplash.jpg" style="padding: 20px;"></a>
