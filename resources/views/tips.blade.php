...
<body style="background-color: rgb(255,255,255);">
    <header>
        <nav class="navbar navbar-dark navbar-expand-md fixed-top" style="background-color: rgba(0,0,0,0.8);padding: 0px 16px;width: 100%;padding-top: 0px;padding-bottom: 0px;">
            <div class="container-fluid"><a class="navbar-brand" href="index.blade.php" style="font-size: 6vw;font-weight: bold;font-style: italic;padding: 5px;padding-left: 0px;"><img src="img/Final%20Web%20Logo.png" style="height: 10%;width: 20%;">&nbsp;FatigueBan</a><button data-toggle="collapse"
                ...
                <table class="table">
                    <tbody class="text-center border-primary">
                        <tr class="text-center" style="height: auto;">
                            <td class="border-white" style="padding-top: 40px;width: 230px;padding-bottom: 0px;height: auto;"><img class="img-fluid" data-bs-hover-animate="pulse" src="img/yawn.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Yawning</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="jello" src="img/speed.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Inragular speed</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="shake" src="img/road.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Not keeping to your lane</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="flash" src="img/sid-view.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Difficulty keeping your eyes open</h1><br><br></td>
                        </tr>
                        <tr class="text-center" style="height: auto;">
                            <td class="border-white" style="width: 230px;height: auto;padding-top: 40px;"><img class="img-fluid" data-bs-hover-animate="swing" src="img/glasses.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Blurred vision</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="tada" src="img/slow.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Slowed resopnse time</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="bounce" src="img/icons8-nod-100.png" width="50px" height="50px" style="width: 50%;">
                                <h1 style="font-size: 3vw;margin-bottom: 0px;margin-top: 20%;">Head nodding</h1><br><br></td>
                            <td class="border-white" style="padding-top: 40px;width: 230px;height: auto;padding-bottom: 0px;"><img class="img-fluid" data-bs-hover-animate="wobble" src="img/car-accident.png" width="50px" height="50px" style="width: 50%;">
    ...
    <div class="article-list" style="background-color: rgb(255,255,255);height: auto;">
        <div class="container" style="padding: 20px;padding-bottom: 0px;">
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="img/bastien-jaillot-eJwSOguD1rE-unsplash.jpg" style="padding: 20px;padding-top: 0px;"></a>
                    <h3 class="name" style="font-size: 24px;">Get a good night sleep<br></h3>
                    <p class="description" style="padding: 20px;padding-top: 0px;">It is always a good idea to be more careful about having a good night sleep whenever you know that you will have to work overtime as a ridesharing driver or if you plan to be on road for longer hours.<br></p><a class="action" href="tips.blade.php"></a></div>
                <div
                    class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="img/mike-kenneally-tNALoIZhqVM-unsplash.jpg" style="padding: 20px;padding-top: 0px;"></a>
                    ...
                    <a
                        class="action" href="welcome.blade.php"></a>
            </div>
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="img/tim-bish-WbC9XIlQb4k-unsplash.jpg" style="padding: 20px;padding-top: 0px;"></a>
                ...
                <p class="description" style="padding: 20px;padding-top: 0px;">If your mind and body are telling you it is time for a rest, then pull over immediately. Don't try and fight through it just to cut a few minutes off of your trip or because the children are sleeping. Turning up the music or opening the
                    window is not an effective strategy to keep you alert. Don't risk falling asleep behind the wheel.</p><a class="action" href="prompt.html"></a></div>
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="img/brooke-lark-nTZOILVZuOg-unsplash.jpg" style="padding: 20px;padding-top: 0px;"></a>
            ...
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="img/lechon-kirb-5tniytQs68E-unsplash.jpg" style="padding: 20px;padding-top: 0px;"></a>
                ...
                <p class="description" style="padding: 20px;padding-top: 0px;">Drivers should take a break before they feel tired. Every few hours plan a short break to stretch your legs and get some fresh air. Driving for an extended period of time without breaking is dangerous for everyone in your car and surrounding
                    cars.</p><a class="action" href="prompt.blade.php"></a></div>
            <div class="col-sm-6 col-md-4 item" style="padding-top: 20px;"><a><img class="img-fluid" src="img/pablo-merchan-montes-wYOPqmtDD0w-unsplash.jpg" style="padding: 20px;padding-top: 0px;"></a>
                ...
                <p class="description" style="padding: 20px;padding-top: 0px;">It is always a good idea to go home in between your day job and driving for ridesharing apps. Going home allows you to ease your mind by having a proper meal, meeting family/ roommates, shower, watching TV, or just by taking a quick 15-30
                    minutes nap before hitting the road again.</p><a class="action" href="prompt.blade.php"></a></div>
        </div>
    </div>
    </div>
